 ...
 * @group Models
 */
export declare type CandyMachineEndSettings = CandyMachineEndSettingsAmount | CandyMachineEndSettingsDate;
/**
 ...
 * @group Models
 */
export declare type CandyMachineEndSettingsAmount = {
 ...
 * @group Models
 */
export declare type CandyMachineEndSettingsDate = {
    /** Differentiates the types of end settings. */
