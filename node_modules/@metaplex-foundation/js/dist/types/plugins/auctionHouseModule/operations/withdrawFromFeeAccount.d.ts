 ...
 * @category Constructors
 */
export declare const withdrawFromFeeAccountBuilder: (metaplex: Metaplex, params: WithdrawFromFeeAccountBuilderParams) => TransactionBuilder<WithdrawFromFeeAccountBuilderContext>;
export {};
