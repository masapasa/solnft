...
class CanceledBidIsNotAllowedError extends AuctionHouseError {
  constructor(options) {
    super({
      ...
      solution: 'Please provide a Bid that is not cancelled in order to execute the sale.'
    });
  }
...
class WithdrawFromBuyerAccountRequiresSignerError extends AuctionHouseError {
  constructor(options) {
    super({
      ...
      problem: 'You are trying to withdraw from buyer account without providing a signer.',
